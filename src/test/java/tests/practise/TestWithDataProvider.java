...
public class TestWithDataProvider extends TestBase {
...
// Mac,ipod ve samsung icin Dataprovider ile yapınız.
    ...
    public void searchFunction(String txtSearch) throws InterruptedException {
        ...
        WebElement searchArea =
                driver.findElement(By.xpath("//input[@name='search']")); // full xpath:  /html/body/header/div/div/div[2]/div/input
        searchArea.clear();
        searchArea.sendKeys(txtSearch);
        WebElement searchBtn =
                driver.findElement(By.cssSelector("button[class='btn btn-default btn-lg']"));  //#search > span > button
        searchBtn.click();
